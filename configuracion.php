...
<CENTER>
                            ...
                            <div id="content" >
                                    ...
                                    <div class="box tabs themed_box">
                                        <h2 class="box-header">
                   <font color="black" size= 5 face="COOPER">CONFIGURACIÓN DE CUENTA</font>
                    </h2>
                                        ...
                                        <iframe src="log_contra.php" id="admin" name="admin" scrolling="no" width="100%" height="100%"  frameborder="0"  onload = "setIframeHeight(this.id)"></iframe>
                                            </div>
                                    </div>
